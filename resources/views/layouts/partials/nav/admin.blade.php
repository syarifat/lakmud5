...
<x-nav-link :href="route('admin.laporan.index')" :active="request()->routeIs('admin.laporan.*')">Rekap Laporan</x-nav-link>
<x-nav-link :href="route('admin.slide-cv')" :active="request()->routeIs('admin.slide-cv')">Slide CV Pemateri</x-nav-link>
